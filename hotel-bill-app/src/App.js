...
const HotelBillScreen = () => {
  ...
  const items = [
    ...
    { id: 6, name: 'Chapathi', cost: 20 },
    { id: 7, name: 'Bonda', cost: 20 },
    { id: 8, name: 'Parota', cost: 20 },
...
const handlePrint = () => {
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: 'center', color: '#333' }}>DEEPTHI'S Hotel Invoice</h2>
  ...
  >
    Add Item
      ...
      <div className="watermark">M.SAI DEEPTHI'S</div>
    </div>
  );
};
